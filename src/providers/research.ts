            ...
            fields: batch.map((field) => ({
              ...
              correction:
                ...
                (field.source
                  ...
                  : proseLanguageMismatch(
                        field.value,
                        field.path.split(".").includes("zh") ? "zh" : "en",
                      )
                    ? `Translate this authored field into ${field.path.split(".").includes("zh") ? "Simplified Chinese" : "English"}. The existing field and counterpart may have swapped languages. Preserve their factual scope, conditions and numbers; retain product names and quoted error messages. Both fields must express the same meaning in their assigned language.`
