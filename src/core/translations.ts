export const zh: Record<string, string> = {
  ...
  "Toggle navigation": "展开导航",
  "Try again": "重试",
  "THE OPEN-SOURCE OPPORTUNITY RADAR": "开源机会雷达",
  "Know where": "看清机会",
  "to build": "再开始做",
  ...
  "Every signal puts search demand against active open-source supply. Explore a category to see what’s behind it.":
    "把搜索需求与活跃开源项目放在一起看。点开赛道，查看判断依据。",
  "categories scanned": "个已扫描赛道",
  "matching active projects*": "个匹配的活跃项目*",
  "Understand the methodology": "了解判断方法",
  "02 / EXPLORE THE LANDSCAPE": "02 / 探索赛道",
  "Your next starting point": "下一次出发，从这里开始",
  "Explore a topic, e.g. agent memory": "输入赛道，例如 ai4s、智能体记忆",
  "Search or scan a topic": "搜索或扫描赛道",
  Scan: "扫描",
  "Search-demand region": "搜索需求地区",
  Worldwide: "全球",
  WORLDWIDE: "全球",
  "United States": "美国",
  "United Kingdom": "英国",
  ...
  Japan: "日本",
  India: "印度",
  "Sort categories": "赛道排序",
  Opportunity: "机会分数",
  "Search growth": "搜索增速",
  "Choose a different Google search term": "调整 Google 搜索关键词",
  "Demand keyword": "需求关键词",
  "Optional — e.g. AI agent memory": "选填，例如 AI agent memory",
  "Keep the GitHub topic above; use this field to measure a more familiar phrase people search for.":
    "保留上方 GitHub 主题，在这里填写用户更常搜索的表达。",
  "All categories": "全部赛道",
  ...
  "Try another topic or clear the category filter.":
    "换一个主题，或清除赛道筛选。",
  "Clear filters": "清除筛选",
  "Explore a new category": "探索新赛道",
  "Fresh evidence takes a moment.": "正在采集最新证据。",
  "Take the radar into your workflow.": "把机会雷达带进工作流。",
  ...
  "Return to the radar to find a category or project.":
    "返回雷达，查找赛道或项目。",
  "Back to radar": "返回雷达",
  "Back to the radar": "返回雷达",
  "Built for the curious. Open for everyone.": "为好奇心而造，向每个人开放。",
  "Source code": "源代码",
  ...
  "Checking GitHub supply and Google search demand. You can keep exploring.":
    "正在检查 GitHub 供给与 Google 搜索需求，你可以继续浏览。",
  "Opening the evidence…": "正在打开报告…",
  "CATEGORY INTELLIGENCE /": "赛道情报 /",
  "Share report": "分享报告",
  "Save image": "保存图片",
  "evidence confidence": "证据置信度",
  "Search demand growth": "搜索需求增速",
  "Last 8 complete weeks vs previous 8": "最近 8 个完整周与此前 8 周对比",
  "Active project supply": "活跃项目供给",
  "≥5 stars · pushed within 180 days": "至少 5 Star · 180 天内有提交",
  "Year-over-year demand": "需求同比",
  "Same 8-week window, one year apart": "与去年同期的 8 周窗口对比",
  "Top 3 attention share": "前三项目关注度占比",
  "Share of stars within returned projects": "占本次返回项目 Star 总量的比例",
  "What demand looks like": "需求趋势",
  ...
  "Total stars": "Star 总数",
  "Stars / last 7 days": "近 7 天新增 Star",
  "Stars / last 30 days": "近 30 天新增 Star",
  License: "许可证",
  ...
  "SIDE BY SIDE": "并排看清差异",
  "Compare the contenders": "对比候选项目",
  "A shared view of growth, activity and maintenance. Choose what deserves a closer look.":
    "一起比较增长、活跃度和维护情况，决定哪些项目值得深入了解。",
  "Repositories to compare": "要对比的仓库",
  Compare: "对比",
  "Gathering comparable repository evidence…": "正在收集可对比的仓库数据…",
  Stars: "Star 数",
  "7-day new stars": "近 7 天新增 Star",
  "30-day new stars": "近 30 天新增 Star",
  "Maintainer response": "维护者回复",
  "Sparklines use independent vertical scales. Compare numeric values for magnitude; star windows follow GitHub calendar buckets.":
    "各缩略图独立缩放，比较规模请看数值；Star 窗口遵循 GitHub 自然日期分桶。",
  "Share comparison": "分享对比",
  "Bring your shortlist": "从你的候选清单开始",
  "Compare two to six public repositories. Start with a category on the radar, or paste repository names above.":
    "支持对比 2–6 个公开仓库。可以从雷达赛道开始，也可以直接输入仓库名称。",
  "YOUR PERSONAL SIGNALS": "你的关注清单",
  "Keep the good ones close": "把好项目留在身边",
  "Follow projects worth returning to. Your list stays in this browser.":
    "关注值得持续观察的项目，清单保存在当前浏览器中。",
  "Add repository to watchlist": "添加仓库到关注清单",
  "Add project": "添加项目",
  ...
  "The four landscapes": "四种赛道类型",
  Landscape: "赛道类型",
  Supply: "供给",
  "Sustained demand growth": "持续需求增速",
  ...
  "Open issues people care enough to react to. Follow the source, understand the workflow, and validate the need.":
    "从有人回应的开放 Issue 出发，阅读原讨论，理解工作流，再验证需求。",
  "Search demand gaps": "搜索需求线索",
  "Search alternative, frustrated, how to…":
  ...
  "Opportunity map: active repository supply from left to right, sustained search demand growth from bottom to top":
    "机会地图：横轴为活跃项目供给，纵轴为持续搜索需求增速",
  "EARLY BLUE": "早期蓝海",
  "Room to build": "仍有切入空间",
  "GROWTH RED": "增长型红海",
  "A rising, crowded field": "需求增长，竞争激烈",
  "QUIET WATERS": "静水区",
  "Validate the need": "先验证真实需求",
  "ESTABLISHED RED": "存量红海",
  "Find your difference": "找到差异化优势",
  "SUSTAINED SEARCH GROWTH →": "持续搜索增速 →",
  "ACTIVE PROJECT SUPPLY →": "活跃项目供给 →",
  "active projects ·": "个活跃项目 ·",
  "search growth": "搜索增速",
  "projects ·": "个项目 ·",
  search: "搜索",
  "Your next opportunity starts with evidence.": "下一次机会，从证据开始。",
  "Scan a topic to place it on the radar.": "扫描一个主题，把它放上雷达。",
  "mapped categories": "个已定位赛道",
  "Click a signal to explore": "点击信号查看",
  stars: "Star",
  "this week": "本周",
  "History is still loading": "历史数据仍在加载",
  "The comparison needs at least two daily observations.":
    "对比至少需要两天的观测数据。",
  "Daily star momentum": "每日 Star 增长趋势",
  "30 days · shared vertical scale": "30 天 · 统一纵轴尺度",
  "Repository daily new stars on a shared scale":
    "使用同一纵轴尺度对比每日新增 Star",
  Radar: "雷达",
  Watchlist: "关注",
  "Demand gaps": "需求线索",
  "How it works": "使用与方法",
  "Early blue ocean": "早期蓝海",
  "Growth red ocean": "增长型红海",
  "Expanding red ocean": "增长型红海",
  "Established red ocean": "存量红海",
  "Quiet waters": "静水区",
  Uncharted: "待验证",
  "More evidence needed": "需要补充证据",
  high: "高",
  moderate: "中",
  low: "低",
  Copy: "复制",
  ...
  "Agents that navigate, write and ship code.":
    "阅读、编写并交付代码的智能体。",
  "Software that turns the web into an action space.":
    "让智能体在网页上执行任务的软件。",
  "Persistent context for agents that learn over time.":
    "让智能体持续学习的长期记忆。",
  "Models and inference that run on your own machine.":
    "在自己设备上运行的模型与推理工具。",
  "The retrieval infrastructure behind AI products.":
    "支撑 AI 产品的信息检索基础设施。",
  "Real-time conversations that get things done.": "通过实时对话完成任务。",
  "Grounding model answers in useful knowledge.": "让模型回答有知识依据。",
  "A custom GitHub topic, paired with Google search interest.":
  ...
  "Repeat the scan with a familiar search phrase and compare the evidence before committing.":
    "使用用户熟悉的搜索表达重新扫描，对比证据后再投入。",
  "Preliminary recommendation": "初步建议",
  "Measured classification": "数据分类",
  ...
  "Field context": "领域背景",
  "Collecting source evidence": "正在收集来源证据",
  "GitHub supply received": "已拿到 GitHub 供给数据",
  "Search history received": "已拿到搜索历史",
  "Core evidence ready; adding project details":
    "核心证据已就绪，正在补充项目详情",
  "{count} active projects found": "已找到 {count} 个活跃项目",
  "{count} complete weeks received": "已收到 {count} 个完整周",
  "Elapsed {seconds}s": "已用时 {seconds} 秒",
  "Waiting behind {count} scan(s)": "前面还有 {count} 个扫描任务",
  "Preliminary result": "初步结果",
  "Interpreting “{input}” as {name}; search term: “{keyword}”.":
    "将“{input}”识别为 {name}；搜索词为“{keyword}”。",
  "You can keep exploring. Source rate limits may delay a fresh scan.":
    "你可以继续浏览。数据源限流可能使首次扫描耗时更长。",
  ...
  "Report dated": "报告日期",
  Method: "方法版本",
  "Matching active GitHub projects": "匹配的活跃 GitHub 项目",
  "Search-interest growth": "搜索热度增速",
  "Search term and region": "关键词与地区",
  "Complete weekly observations": "完整周观测数",
  "Why this classification": "判断依据",
  "Source evidence": "原始证据",
  Collected: "采集于",
  ...
  "View this snapshot": "查看这份快照",
  "Local report": "本地报告",
  Repository: "仓库",
  Description: "简介",
  "Permanent report": "固定报告链接",
  "PNG card": "PNG 卡片",
  "GitHub repository search": "GitHub 仓库搜索",
  "Google Trends search interest": "Google Trends 搜索热度",
  "Use the open-source CLI and MCP server on GitHub":
    "在 GitHub 获取开源 CLI 与 MCP 服务",
  "Full installation and configuration instructions": "完整安装与配置说明",
  "MIT source code": "MIT 开源代码",
  "ghtrends — Know where to build": "ghtrends — 看清机会，再开始做",
  "GitHub opportunity analysis: methodology, CLI and MCP · ghtrends":
    "GitHub 机会分析：方法、CLI 与 MCP · ghtrends",
  "Open-source feature requests and friction signals · ghtrends":
    "开源功能请求与使用阻力 · ghtrends",
  "Compare GitHub repositories · ghtrends": "对比 GitHub 仓库 · ghtrends",
  "Your GitHub watchlist · ghtrends": "你的 GitHub 关注清单 · ghtrends",
  "Repository intelligence · ghtrends": "仓库情报 · ghtrends",
  "Compare GitHub repositories": "对比 GitHub 仓库",
  "Your GitHub watchlist": "你的 GitHub 关注清单",
  "Repository intelligence": "仓库情报",
